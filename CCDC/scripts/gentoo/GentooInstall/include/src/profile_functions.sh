...
{
  echo "Here is a list of profiles that can be used. Enter the number of the one that you want to use."
  echo "Do note that the more specific you get, the longer this install will take. KDE and Gnome are massive."
  ...
  echo "About to rebuild the packages affected by your choice. Make sure your computer won't die or go to sleep,
  ...
  echo "Refer to XKCD 303. Press enter to continue."
